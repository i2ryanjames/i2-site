...
- Homepage hero: a dark "hero v2" (Muse draft) was shipped and REVERTED the same day — Ryan rejected it on sight. The light
  hero with the grid/glow treatment is the one to keep; do not re-propose a dark hero.
